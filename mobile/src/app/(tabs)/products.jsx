  ...
  return (
    <View style={{ flex: 1, backgroundColor: T.bg, paddingTop: insets.top }}>
      ...
      {mounted && <Modal
        ...
        animationType="fade"
        transparent
        onRequestClose={() => setMergeModal(false)}
      >
        <KeyboardAvoidingView
          style={{ flex: 1 }}
            ...
            <View style={{ backgroundColor: T.bg, borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 24, paddingBottom: 40 }}>
              ...
              {supplierNames
                ...
                .map((s) => (
                  <TouchableOpacity
                    key={s}
                    onPress={() => setMergeCanonical(s)}
                    style={{ paddingVertical: 9, paddingHorizontal: 14, borderRadius: 8, backgroundColor: T.surface, borderWidth: 1, borderColor: T.line, marginBottom: 4 }}
                  >
