          ...
          {processing ? (
            ...
            <View>
              ...
              {images.length > 0 && (
                <TouchableOpacity
                  activeOpacity={0.88}
                  onPress={() => images.length === 1 ? processImages("separate") : setModeModal(true)}
                  style={{
      ...
      <Modal visible={modeModal} animationType="slide" transparent onRequestClose={() => setModeModal(false)}>
        <View style={{ flex: 1, backgroundColor: "rgba(0,0,0,0.45)", justifyContent: "flex-end" }}>
          <View style={{ backgroundColor: T.bg, borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 24, paddingBottom: 40 }}>
            ...
            >
              <Text style={{ fontSize: 16, fontWeight: "700", color: T.ink, marginBottom: 4 }}>Facturas distintas</Text>
            ...
            >
              <Text style={{ fontSize: 16, fontWeight: "700", color: T.primary, marginBottom: 4 }}>Una sola factura (varias páginas)</Text>
